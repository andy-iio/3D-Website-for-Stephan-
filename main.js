...
//create textures
const groundTexture = new THREE.TextureLoader().load('https://github.com/andy-iio/stephanWebsiteIdea/blob/main/img/groundTexture.png');
const houseTexture = new THREE.TextureLoader().load('restaraunt.png');
